  ...
  return (
    <div className="lg:ml-60 pb-20 lg:pb-0">
      ...
      <main className="max-w-2xl mx-auto p-4 space-y-4">
        <h1 className="text-xl font-bold pt-4" style={{ color: 'var(--color-primary)' }}>統計</h1>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div key={card.label} className="bg-white rounded-2xl border p-4 text-center" style={{ borderColor: 'var(--color-border)' }}>
        ...
        {/* ストリーク */}
        <div className="bg-white rounded-2xl border p-4 flex gap-6" style={{ borderColor: 'var(--color-border)' }}>
